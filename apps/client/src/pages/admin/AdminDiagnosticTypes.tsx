...
export default function AdminDiagnosticTypes() {
    ...
    const [statusTarget, setStatusTarget] = useState<DiagnosticTypeDto | null>(null);
    ...
    return (
        <div className="space-y-6 animate-fade-in">
                    ...
                    {editingItem && (
                        <div className="space-y-4">
                            <div>
                                <Label>Title</Label>
                                <Input
                                    placeholder="Enter diagnostic type"
            ...
            <ConfirmDialog
                ...
                title={`${statusTarget?.isActive ? "Deactivate" : "Activate"} diagnostic type`}
                description={`Are you sure you want to ${
                    statusTarget?.isActive ? "deactivate" : "activate"
                } ${statusTarget?.title || "this diagnostic type"}?`}
