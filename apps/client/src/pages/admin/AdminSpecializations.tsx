...
export default function AdminSpecializations() {
    ...
    const [statusTarget, setStatusTarget] = useState<SpecializationDto | null>(null);
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            ...
            <ConfirmDialog
                ...
                title={`${statusTarget?.isActive ? "Deactivate" : "Activate"} specialization`}
                description={`Are you sure you want to ${
                    statusTarget?.isActive ? "deactivate" : "activate"
                } ${statusTarget?.title || "this specialization"}?`}
